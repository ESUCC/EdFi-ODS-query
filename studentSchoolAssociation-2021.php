...
// Config
$edfiBaseUrl = "https://sandbox.nebraskacloud.org/2021/api";
$dbHost = "172.16.3.38";
$dbPort = 5434;
$dbUser = "psql-primary";
$dbName = "nebraska_srs";
  ...
  "_ext": {
    "NE": {
      ...
      "residentLocalEducationAgencyReference": {
        "localEducationAgencyId": ' . getLEAId($schoolId) . ',
        "link": {
          "rel": "string",
          "href": "string"
        }
...
function getLEAId ($stringSchoolId)
{
  if (strlen($stringSchoolId) == 9 && substr($stringSchoolId,0,1) == '0')
  {
    return (substr($stringSchoolId,1,5) . '000');
  }
  else
  {
    return (substr($stringSchoolId,0,6) . '000');
  }
}
